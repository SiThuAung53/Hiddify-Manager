...
if [[ "$TAG" == "develop" || "$TAG" == "dev" ]]; then
    ...
    git clone https://github.com/SiThuAung53/Hiddify-Manager.git
    cd Hiddify-Manager
  ...
  cd hiddify-manager
  wget https://raw.githubusercontent.com/SiThuAung53/Hiddify-Manager/refs/heads/main/docker-compose.yml
fi
